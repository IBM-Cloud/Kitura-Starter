...
[![Build Status - Develop](https://travis-ci.org/IBM-Cloud/Kitura-Starter.svg?branch=develop)](https://travis-ci.org/IBM-Cloud/Kitura-Starter)
...
To compile and run this starter application on your local system, you need to install the [Swift compiler](https://swift.org/download/) for your platform. This version of Kitura-Starter works with the Swift `4.0.2` release binaries. Compatibility with other Swift versions is not guaranteed.
